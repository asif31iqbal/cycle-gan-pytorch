...
Over the last couple of years, Generative Adversarial Networks (GANs) \citep{gan1, gan2} have achieved
...
works, \citep{rel19}, \cite{rel20} and \cite{21} are the ones that are conceptually most similar to 
CycleGANs.
