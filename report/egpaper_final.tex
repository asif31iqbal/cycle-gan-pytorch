...
example, that they are two different renderings of the same underlying scene – and 
seek to learn that relationship. Although the algorithm lacks supervision in the form 
...
images $y \in Y$ by an adversary trained to classify $\hat{y}$ apart from $y$ \cite{cyclegan}.
